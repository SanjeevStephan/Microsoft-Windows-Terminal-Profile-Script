...
#-------------------- Include Below File --------------------------------------#>
# Defined the path and Load the configuration file that contains additional dependencies
...
$profile_dependencies = @{
    ...
    "profile_getFunction"= "$profile_source\profile_getFunction.ps1"
...
. $profile_dependencies["profile_getFunction"]
