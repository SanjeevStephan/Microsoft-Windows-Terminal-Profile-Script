...
$script = $script_db | Where-Object { $_.Name -eq $scriptName }
...
function execute_script() { 
    ...
    if ($script) { if ($argument) { & $script.Path $argument} else { & $script.Path } } else { Write-Error "Script '$scriptName' not found" }
