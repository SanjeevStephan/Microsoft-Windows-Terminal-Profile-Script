...
# Get all the files in the current directory and append their names and paths to an array
$files = Get-ChildItem $fileDirtoscan | Where-Object { !$_.PsIsContainer } | ForEach-Object {
    [PSCustomObject]@{
        Name = $_.Name
        Path = $_.FullName
    }
