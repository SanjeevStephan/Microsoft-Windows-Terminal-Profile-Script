...
$existingUsername = "OneDriveOneDrive" # $SYSTEM.username
$currentUsername  = "OneDrive"
<#
$existingUsername = "Samst\\OneDriveOneDrive" # $SYSTEM.username
$currentUsername  = "$envUser\\OneDrive"
#>
