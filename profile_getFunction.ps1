...
if($DEBUG["debug_function"] -eq "enable"){ Write-Output "[ OK ] Profile getFunction => { profile_getfunction.ps1 } Loaded Successfully"} 
   
# Read the JSON data from the file
$function_json_raw_data = Get-Content -Path "$Home\Documents\PowerShell\functions.json" -Raw
...
$functions = Get-FunctionFromJSON "C:\Users\Sanju\Documents\PowerShell\functions.json"
